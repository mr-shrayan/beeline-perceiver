...
label_8=Label(root1,text="      You can unselect them by clicking on the same Node using Right Click Or Press with 2 fingers for mac users\n",font=(10))
...
label_6=Label(root1,text="5. One Can Rerun the same Algorithm using the same Space Bar(Only after execution of the Algorithm).\n",font=(10))
...
def algorithm(Algorithm,draw, grid, start, end,diag):
	...
	print("Algorithm Failed!! Execution Stopped!!")
